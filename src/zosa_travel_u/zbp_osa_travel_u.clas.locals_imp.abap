...
METHOD create.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING ZOSA_S_TRAVEL_X( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZOSA_TRAVEL_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZOSA_TRAVEL_U IMPLEMENTATION.
